...
![Version: v0.11.0-4](https://img.shields.io/badge/Version-v0.11.0--4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.11.0-4](https://img.shields.io/badge/AppVersion-v0.11.0--4-informational?style=flat-square)
...
| images.tag | string | `"v0.11.0-4"` | Image tag for the http add on. This tag is applied to the images listed in `images.operator`, `images.interceptor`, and `images.scaler`. Optional, given app version of Helm chart is used by default |
