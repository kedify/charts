...
![Version: v2.18.3-4](https://img.shields.io/badge/Version-v2.18.3--4-informational?style=flat-square) ![AppVersion: v2.18.3-4](https://img.shields.io/badge/AppVersion-v2.18.3--4-informational?style=flat-square)
...
| image.keda.tag | string | `"v2.18.3-4"` | Image tag of KEDA operator. Optional, given app version of Helm chart is used by default |
...
| image.metricsApiServer.tag | string | `"v2.18.3-4"` | Image tag of KEDA Metrics API Server. Optional, given app version of Helm chart is used by default |
...
| image.webhooks.tag | string | `"v2.18.3-4"` | Image tag of KEDA admission-webhooks . Optional, given app version of Helm chart is used by default |
